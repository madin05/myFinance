...
/**
 * Modal Verifikasi Aktivasi 2FA via Kode OTP 6-Digit.
 * Dipanggil saat pengguna menggeser switch 2FA ke posisi ON.
 */
        ...
        <div class="modal-content" style="max-width: 440px; text-align: center;">
          ...
          <form id="form-enable-2fa-otp">
            <div class="otp-grid" style="display: flex; gap: 8px; justify-content: center; margin-bottom: 1.25rem;">
              <input type="text" class="otp-box-digit" maxlength="1" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required style="width: 44px; height: 52px; text-align: center; font-size: 1.3rem; font-weight: 700; border-radius: 10px; border: 1.5px solid var(--border-color); background: var(--bg-color); color: var(--text-main);" />
              <input type="text" class="otp-box-digit" maxlength="1" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required style="width: 44px; height: 52px; text-align: center; font-size: 1.3rem; font-weight: 700; border-radius: 10px; border: 1.5px solid var(--border-color); background: var(--bg-color); color: var(--text-main);" />
              <input type="text" class="otp-box-digit" maxlength="1" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required style="width: 44px; height: 52px; text-align: center; font-size: 1.3rem; font-weight: 700; border-radius: 10px; border: 1.5px solid var(--border-color); background: var(--bg-color); color: var(--text-main);" />
              <input type="text" class="otp-box-digit" maxlength="1" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required style="width: 44px; height: 52px; text-align: center; font-size: 1.3rem; font-weight: 700; border-radius: 10px; border: 1.5px solid var(--border-color); background: var(--bg-color); color: var(--text-main);" />
              <input type="text" class="otp-box-digit" maxlength="1" inputmode="numeric" pattern="[0-9]*" autocomplete="off" required style="width: 44px; height: 52px; text-align: center; font-size: 1.3rem; font-weight: 700; border-radius: 10px; border: 1.5px solid var(--border-color); background: var(--bg-color); color: var(--text-main);" />
